...
# Судя по тому как я понял из лекции, чем больше PSNR(пиковое сигнал/шум) тем меньше сама ошибка квантизации.
# Соответственно, в нашем случае, мы получили большую ошибку квантизации в Floyd-Steinberg Dithering.
# Хотя визуально для нашего глаза лучше выглядит именно Floyd-Steinberg Dithering, хотя имеет и большую ошибку


# Which image looks better to you?
# Floyd-Steinberg Dithering выглядит лучше для меня


# Can you repeat the same process using only two colours: black and white? Show me :-)
# Да, повторил в файлике homwork5BlackAndWhite. По сути нужно было просто убрать 2 строчки в матрице цветов и оставить только черный и белый


# Бонусное задание выполнил в файлике BonusTask